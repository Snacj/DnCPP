...
void UI::draw() {
    ...
    SDL_RenderCopy(gRenderer, start_game_button.texture, NULL,
                   &start_game_button.destRect);
    SDL_RenderCopy(gRenderer, quit_game_button.texture, NULL,
                   &quit_game_button.destRect);
}
...
void UI::createButtons() {
    ...
    start_game_button.destRect.x =
        SCREEN_WIDTH / 2 - (start_game_button.destRect.w / 2);
    start_game_button.destRect.y =
        SCREEN_HEIGHT / 2 - (start_game_button.destRect.h / 2);
    ...
    quit_game_button.destRect.x =
        SCREEN_WIDTH / 2 - (quit_game_button.destRect.w / 2);
    quit_game_button.destRect.y =
        SCREEN_HEIGHT / 2 - (quit_game_button.destRect.h / 2) + 96;
